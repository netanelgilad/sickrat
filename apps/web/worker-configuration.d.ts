/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: aa629f04277dfcd9019d306380660f42)
// Runtime types generated with workerd@1.20260603.1 2026-06-06 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	APPROVAL_HUB: DurableObjectNamespace<import("./src/worker/index").ApprovalHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "ApprovalHub";
	}
