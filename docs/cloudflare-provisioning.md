...
- Worker vars for vault-specific VAPID push keys
...
4. The CLI builds the Sickrat PWA/Worker artifact.
...
- How the published CLI should carry the Worker/PWA artifact: embedded bundle, downloaded release asset, or source checkout during development.
